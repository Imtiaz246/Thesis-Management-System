...
import (
	...
	jwt2 "github.com/Imtiaz246/Thesis-Management-System/pkg/jwt"
	"github.com/Imtiaz246/Thesis-Management-System/test/mocks/service"
	"time"
...
func TestMain(m *testing.M) {
	fmt.Println("begin")
	err := os.Setenv("APP_CONF", "../../../config/config.yml")
	if err != nil {
